...
export default function LeaguesComponent({children, leagues = null, is_live_now = false}) {
  if (!leagues) {
    leagues = [
      {
      ...
      {
        path: 'listView/tennis/wta/all/all/matches.json?lang=en_GB&market=GB&includeParticipants=false&useCombined=true&useCombinedLive=true',
        // fullPath: 'https://eu-offering-api.kambicdn.com/offering/v2018/kambi/listView/tennis/grand_slam/us_open/all/matches.json?lang=en_GB&market=GB&includeParticipants=false&useCombined=true&useCombinedLive=true',
        fullPath: 'https://eu-offering-api.kambicdn.com/offering/v2018/kambi/listView/tennis/wta/all/all/matches.json?lang=en_GB&market=GB&includeParticipants=false&useCombined=true&useCombinedLive=true',
        // fullPath: 'https://eu-offering-api.kambicdn.com/offering/v2018/kambi/listView/tennis/itf_women/all/all/matches.json?lang=en_GB&market=GB&includeParticipants=false&useCombined=true&useCombinedLive=true',
        sport: 'TENNIS',
        sport_code: 'tennis',
        groupMatches: false,
        label: 'Tennis',
    ...
    <div className="leagues-container dark">
      ...
      <div className="leagues-wrapper">
        <div className="events-list-container">
          <EventsList league={league} is_live_now={is_live_now} />
        </div>
      </div>
    </div>
  );
